...
namespace WebStore.Services.DataBase
{
    public static class TestData
    {
        ...
        public static IEnumerable<Domain.Entities.Product> Products { get; } = new[]
        {
            ...
            new Domain.Entities.Product { Id = 3, Name = "Easy Black Dress", Price = 1025, ImageUrl = "product3.jpg", Order = 2, SectionId = 2, BrandId = 1 },
            new Domain.Entities.Product { Id = 4, Name = "Black Dress", Price = 1025, ImageUrl = "product4.jpg", Order = 3, SectionId = 2, BrandId = 1 },
            new Domain.Entities.Product { Id = 5, Name = "Blue Sweater", Price = 1025, ImageUrl = "product5.jpg", Order = 4, SectionId = 2, BrandId = 2 },
            new Domain.Entities.Product { Id = 6, Name = "White T-Short", Price = 1025, ImageUrl = "product6.jpg", Order = 5, SectionId = 2, BrandId = 1 },
            new Domain.Entities.Product { Id = 7, Name = "White Dress", Price = 1025, ImageUrl = "product7.jpg", Order = 6, SectionId = 2, BrandId = 1 },
            new Domain.Entities.Product { Id = 8, Name = "Pink Rabbit", Price = 1025, ImageUrl = "product8.jpg", Order = 7, SectionId = 25, BrandId = 1 },
            new Domain.Entities.Product { Id = 9, Name = "Red Chinese Dress", Price = 1025, ImageUrl = "product9.jpg", Order = 8, SectionId = 25, BrandId = 1 },
